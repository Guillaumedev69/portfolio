  ...
  return (
    <main className="main" >
      ...
      <section className="sectionInfo" id="about">
        ...
        <div className="containerTitlePBtn">
          ...
          <p className="pInfo">
            ...
            outils tels que Figma, Lighthouse, Wave, Trello, Notion, Slack etc.
            Vous trouverez quelques uns de mes projets dans mon portfolio.
            <br />
            <br /> Je suis à la recherche d&apos;opportunités professionnelles
            en tant que développeur front end/fullstack. Je suis à l&apos;écoute
            de toute proposition d&apos;emploi salarié et/ou de mission en
            freelance.
            <br />
            <br /> Je mettrai à votre service toutes mes connaissances, mes
            compétences et ma motivation et saurai m&apos;investir, apprendre et
            me perfectionner au quotidien.
          </p>
        </div>
        <img
          src={PhotoProfil}
      ...
      <section className="sectionContact" id="contact">
        ...
        <p>Le formulaire n&apos;est pas encore actif merci de cliquer directement sur le bouton &ldquo;Contactez-moi !&rdquo;</p>
        <ContactForm />
      <a href="#main" ><FontAwesomeIcon icon={faAnglesUp} /></a>
      </section>
    </main>
  );
};
